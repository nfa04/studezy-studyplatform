class AssignmentSelector {
    ...
    displayAssignments(assignments, resolveCallback) {
        assignments.forEach(assignment => {
            var div = document.createElement("div");
            div.innerText = assignment['title'];
            this.optionsNode.appendChild(div);
            div.addEventListener("click", () => resolveCallback(assignment['id']));
        });
    }
    ...
    chooseFromCourse() {
        ...
        return new Promise((resolve, reject) => {
            new APIRequest("get_assignments_in_course").sendAndFetch({
                id: this.courseID
            }).then(res => {
                this.displayAssignments(JSON.parse(res), resolve);
            });
        });
    }
    ...
    chooseFromUser() {
        ...
        this.controlsNode.replaceChildren();
        return new Promise((resolve, reject) => {
            new APIRequest("get_assignments_by_user").fetch().then(res => {
                this.displayAssignments(JSON.parse(res), resolve);
            });
        });
    }
    ...
    chooseFromAll() {
        ...
        return new Promise((resolve, reject) => {
            ...
            searchBtn.addEventListener("click", () => {
                new APIRequest("suggest_assignments_by_name").sendAndFetch({
